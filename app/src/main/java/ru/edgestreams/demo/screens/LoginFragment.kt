package ru.edgestreams.demo.screens
...
import ru.edgestreams.demo.databinding.FragmentLoginBinding
import ru.edgestreams.demo.extensions.afterTextChangedListener
import ru.edgestreams.demo.model.data.remote.RemoteAccessManager
...
class LoginFragment : Fragment(R.layout.fragment_login) {
    ...
    private val eMailAfterTextListener = object :
        ru.edgestreams.demo.extensions.TextWatcherAfterTextCallback {
    ...
    private val passwordAfterTextListener = object :
        ru.edgestreams.demo.extensions.TextWatcherAfterTextCallback {
        override fun afterTextChanged(editable: Editable?) {

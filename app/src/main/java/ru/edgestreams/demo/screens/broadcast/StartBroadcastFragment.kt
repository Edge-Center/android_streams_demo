...
import ru.edgestreams.demo.databinding.FragmentStartBroadcastBinding
        ...
        .observe(viewLifecycleOwner) { resolution ->
            ...
            when (resolution!!) {
                StreamResolution.FULL_HD -> {
                    binding.fullHdQualityTV.setTextColor(getColor(requireContext(), R.color.primary_blue))
                }
                StreamResolution.HD -> {
                    binding.hdQualityTV.setTextColor(getColor(requireContext(), R.color.primary_blue))
                }
                StreamResolution.SD -> {
                    binding.sdQualityTV.setTextColor(getColor(requireContext(), R.color.primary_blue))
                }
            }
        }
